...
| `orchestrator/vault.py` | SQLite: threads per workspace, messages, window/texturize/archive, summaries, artifacts, health sweep, vision digest, migration | database_path, initialize_database, active_thread, thread_by_id, list_threads, create_thread, switch_thread, rename_thread, set_thread_status, clear_thread, delete_thread, estimate_tokens, redact_secrets, append_message |
