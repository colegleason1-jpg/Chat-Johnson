...
| `orchestrator/preview.py` | nh3 allowlist sanitizer + preview document + markup extraction (fences, unclosed fence, data:text/html links) | sanitize_markup, looks_like_markup, looks_like_link, decode_data_link, resolve_preview_source, extract_preview_source, safe_preview_document |
