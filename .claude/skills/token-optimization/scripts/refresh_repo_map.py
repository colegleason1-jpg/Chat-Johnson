...
ENTRIES = [
    ...
    ("orchestrator/vault.py", "SQLite: threads per workspace, messages (with the vendor finish reason and the cut note), live window before memory (digest capped at 1/8 as background), texturize/archive, summaries, artifacts, health sweep (automatic turns excluded), vision digest (decisions from the operator only), migration, recall (stopwords, whole words)"),
